...
<br>
<p>Acesse o sistema pelo endere�o: https://app.copytraderbrasil.com.br</p>
<p>E-mail: $email
...
<h4><b>Favor Alterar da senha na IQ Option por quest�es de Seguran�a</b></h4>
<br>
...
if (isset($_POST["adm"]) && isset($_POST["email2"])) {
    ...
    if (isset($_POST["contaIQ"]) && isset($_POST["pagamento"])) {
        ...
        echo '<div style="color: red; position: absolute; top: 46%; left: 45%;">Pendências detectadas</div>';
    }
}
