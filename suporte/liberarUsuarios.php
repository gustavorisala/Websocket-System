							...
							<div class="col">
								...
								<div class="row mt-3 mb-3">
									<div class="col mx-auto">
										<div class="row">
											<div class="col">
												<input type="checkbox" value="contaIQ" name="contaIQ">
												Confirmar Conta IQ Criada
											</div>
										</div>
										<div class="row">
											<div class="col">
								...
								<div class="row">
									<div class="col">
										<input type="hidden" name="email2"
											value="<?=$dadosUser["email"]?>"> <input type="hidden"
											name="adm" value="<?=$_SESSION['id_usuario']?>"> <input
											type='submit' class="btn p-3" value='Liberar Usuário'>
									</div>
								</div>
							</div>
						</div>
